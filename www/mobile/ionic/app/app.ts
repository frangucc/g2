...
const ROUTES = [
  { path: '/action-sheets/basic', component: actionSheets.BasicPage},
  ...
  { path: '/cards/packs', component: cards.PacksPage },

  { path: '/checkboxes/basic', component: checkboxes.BasicPage },

  { path: '/gestures/basic', component: gestures.BasicPage },

  { path: '/grid/basic', component: grid.BasicPage, useAsDefault: true  },
  { path: '/grid/about', component: grid.AboutPage },
  { path: '/grid/book', component: grid.BookPage },
  { path: '/grid/packs', component: grid.PacksPage },
  { path: '/grid/buybook', component: grid.BuybookPage },
  ...
  { path: '/lists/chapters', component: lists.ChaptersPage },
  ...
  { path: '/tabs/chapter', component: tabs.ChapterPage },
